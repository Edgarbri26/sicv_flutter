 ...
 * * * 2. Navegación:
 * - Este archivo ahora es una pantalla completa (usa Scaffold).
 * - Para llamarla desde otra parte de tu app (ej. un botón), usa:
 *
 * Navigator.push(
 * context,
 ...
 * useMaterial3: true,
 * ),
 * // Simula un botón para navegar a la página de reportes
 * home: Builder(
...
/// ReportPage
///
/// Página completa (con Scaffold) que muestra reportes con gráficos filtrables
/// y una vista de pestañas (Ventas/Compras).
///
...
class _ReportPageState extends State<ReportPage>
  ...
  Widget build(BuildContext context) {
    // *** SOLUCIÓN AL ERROR ***
    // Envolvemos el Column en un Scaffold.
    // El Scaffold proporciona el ancestro 'Material' que 'DropdownButton'
    // necesita para dibujarse correctamente.
    // Esto también convierte el widget en una pantalla completa.
    return Scaffold(
      appBar: AppBar(
        title: Text('Reportes'),
        elevation: 1, // Una ligera sombra para el appbar
      ),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          // Este DropdownButton ahora funcionará porque tiene un
          // Scaffold (y por lo tanto un 'Material') como ancestro.
