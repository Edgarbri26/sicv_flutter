...
class _MovementsScreenState extends State<MovementsScreen> {
  ...
  void _runFilter() {
    ...
    if (_selectedUser != null && _selectedUser!.isNotEmpty) {
      results = results
          .where((m) => m.userName == _selectedUser)
          .toList();
    }
  ...
  Widget _buildUserFilter() {
    ...
    return DropdownButton<String>( // ⭐️ Usamos DropdownButton simple
      ...
      child: Card(
        ...
        child: DataTable(
          ...
          columns: [
            ...
            DataColumn(label: Text('Stock Ant.', style: TextStyle(fontWeight: FontWeight.bold)), numeric: true),
            // Índice de Columna 5: Stock Desp. (Sin onSort, por defecto)
            DataColumn(label: Text('Stock Desp.', style: TextStyle(fontWeight: FontWeight.bold)), numeric: true),
            ...
            return DataRow(cells: [
              ...
              Row(
                children: [
                  SizedBox(width: 15.0), 
                  IconButton(
                    icon: Icon(Icons.info, size: 20, color: Colors.blue.shade700),
...
// void _runFilter();
  ...
  void _showAddMovementModal(BuildContext context) {
    ...
    showModalBottomSheet(
      context: context,
      isScrollControlled: true, // Permite que ocupe casi toda la pantalla para el teclado
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            DropdownButtonFormField<Product>(
                              ...
                              onChanged: productsForSelection.isEmpty ? null : (Product? newValue) {
                                setStateDialog(() {
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                alignLabelWithHint: true, // Alinea el label en multilínea
                                enabledBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(12),
                                  borderSide: BorderSide(
                                    width: 3.0, // <-- Tu grosor deseado
  ...
  void _handleSaveAdjustment(
    ...
    if (quantity == null || quantity <= 0) {
      ScaffoldMessenger.of(pageContext).showSnackBar(
        const SnackBar(content: Text('Por favor, ingresa una cantidad válida (mayor a cero).'), backgroundColor: Colors.orange),
      );
      return;
    }
    ...
    final int signedQuantity = 
        (selectedAdjustmentType == MovementType.ajustePositivo) ? quantity : -quantity;
