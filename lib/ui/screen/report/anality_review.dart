...
class AnalyticsState {
  ...
  final List<ProductCorrelation> dataPoints = [
    ...
    ProductCorrelation(
      ...
      5,
      Colors.blue,
    ), // Mucha venta, Poco margen (Volumen)
    ProductCorrelation(
      "Monitor 4K",
      20,
      45,
      Colors.orange,
    ), // Poca venta, Alto margen (Nicho)
    ProductCorrelation(
      "Funda Vieja",
      10,
      2,
      Colors.grey,
    ), // Poca venta, Poco margen (Descontinuar)
        ...
        scatterSpots: points.map((point) {
          return ScatterSpot(
            ...
            dotPainter: FlDotCirclePainter(
              color: point.color,
              radius:
                  8 + (point.volumeX / 50), // El tamaño también indica volumen
              strokeWidth: 2,
        ...
        scatterTouchData: ScatterTouchData(
          ...
          touchTooltipData: ScatterTouchTooltipData(
            ...
            getTooltipItems: (ScatterSpot spot) {
              ...
              final product = points.firstWhere(
                (p) => p.volumeX == spot.x && p.marginY == spot.y,
              );
