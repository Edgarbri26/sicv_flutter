...
//       // final Set<String> permissionsForRole = roles ?? {};
...
//   void _updatePermission(int idPermission, bool value) {
//     setState(() {
//       for (var p in rolActivo.permissions) {
//         p.permissionId == idPermission ? p.status = value : null;
//       }
//     });
//   }
