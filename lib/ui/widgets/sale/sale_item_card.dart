...
class SaleItemCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      elevation: 0,
      color: AppColors.secondary, // Fondo blanco para destacar
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(10),
        side: const BorderSide(color: AppColors.border), // Borde sutil
      ),
      child: Padding(
                  ...
                  if (item.expirationInfo != null) ...[
                    ...
                    Row(
                      children: [
                        ...
                        Icon(Icons.event, size: 14, color: AppColors.edit),
                        const SizedBox(width: 4),
                        Expanded(
                          child: Text(
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "${((item.unitPriceBs * item.amount).toStringAsFixed(2))}Bs",
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 12,
                        color: AppColors.textSecondary,
