...
class SaleDetailModal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final date = DateFormat('dd MMM yyyy, HH:mm').format(DateTime.now()); // Usa sale.createdAt si lo tienes
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 10),
                Text(
                  currency.format(sale.totalUsd), // Asegúrate de tener un getter 'total' en SaleModel o calcúlalo
          ...
          Expanded(
            child: ListView(
              padding: const EdgeInsets.all(20),
              children: [
                _buildInfoRow("Cliente", sale.clientName), // O sale.clientName si tienes el join
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text("Producto: ${item.productName}", style: const TextStyle(fontWeight: FontWeight.w500)), // Idealmente el nombre
                            Text(currency.format(item.unitCost), style: const TextStyle(fontSize: 12, color: Colors.grey)),
                          ],
                        ),
                      ),
                      Text(
